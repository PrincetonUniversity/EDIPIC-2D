...
module physical_constants
  ...
  REAL, PARAMETER :: e_Cl     = 1.602189e-19      ! Charge of single electron [Cl]
  REAL, PARAMETER :: m_e_kg   = 9.109534e-31      ! Mass of single electron [kg]
  REAL, PARAMETER :: eps_0_Fm = 8.854188e-12      ! The dielectric constant [F/m]

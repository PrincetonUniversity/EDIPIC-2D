...
This version of the code (12-March-2022) can simulate the circuit described above (1), as well as two other simple circuits, namely: 
...
(change 1 for 2 or 3 in line 1765). 
...
history_ext_circuit.dat, see lines 1859-1870 in file pic2d_ExternalCircuits.f90. If one uses a more complex circuit, this 
